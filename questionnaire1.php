  ...
  <main>
    ...
    <div id="article">
      <section>
        ...
        <p class="line">アンケート</p>
        <p>
          PHP独学の一環で作成したアンケートです。
          <br><br>
          もしよろしければ、アンケート回答のご協力をお願い致します。
          <br><br>
          集計結果を確認できるようにしてあります。
        </p>
        <hr>
        ...
        <form action="questionnaire2.php" method="post">
          ...
          <div class="gender">
            ...
            <input type="radio" name="gender" id="female" value="3">
            <label for="female"> なし </label>
          </div>
          <br>
          ...
          <div class="lover">
            ...
            <br>
            <input type="radio" name="lover" id="exist1" value="3">
            <label for="exist1"> いる(お付き合い1年以上) </label>
            <br>
            <input type="radio" name="lover" id="exist1" value="4">
            <label for="exist1"> いる(お付き合い3年以上) </label>
            <br>
            <input type="radio" name="lover" id="exist1" value="5">
            <label for="exist1"> いない(1年未満) </label>
            <br>
            <input type="radio" name="lover" id="exist1" value="6">
            <label for="exist1"> いない(1年以上) </label>
            <br>
            <input type="radio" name="lover" id="exist1" value="7">
            <label for="exist1"> いない(3年以上) </label>
            <br>
            <input type="radio" name="lover" id="exist1" value="8">
            <label for="exist1"> いない(友達以上、恋人未満の存在有) </label>
            <br>
            <input type="radio" name="lover" id="exist1" value="9">
            <label for="exist1"> その他 </label>
          ...
          <div>
            ...
            $ids = array('personality', 'sincerity', 'appearance', 'economy', 'educated', 'housework', 'values', 'childcare', 'family', 'age', 'tolerance', 'Interesting', 'sense', 'compatibility', 'dislikes', 'gambling', 'others');
