    ...
    <div id="article">
      <section>
        ...
        <div class="accbox">
          ...
          <label for="0000"><span><img class="icon" src="gallery/ICONS/avocado.png" alt="">READ</span></label>
          <div class="accshow">
            <p>
              ...
              <br><br>
              1品種だけでは結実しにくいと言われているので、2021年は、結実の為にもう一つ品種を栽培始めようと考え始めたところです。
            </p>
          </div>
        </div>
        <br><br>
        ...
        <div class="accbox">
          ...
          <label for="035"><span><img class="icon" src="gallery/ICONS/avocado.png" alt="">READ</span></label>
          <div class="accshow">
