...
<html lang="ja">
  ...
  <head>
    ...
    <meta name=”robots” content=”index”>
		...
		<meta name="keywords" content="プログラミング,新型コロナ,Java,404">

    <title>しらひゅーのわくわくスタディ ERROR404</title>
  ...
  <?php include('../parts/facebook_twitter_button.php'); ?>
    ...
    <main>
      ...
      <div id="article">
        <ul>
          <div class="line">ERROR404　NOT FOUND</div>
          <p>
            <image id="top-img" src="../gallery/top/error404.png" alt="小物">
          </p>
          <p>申し訳ございません。指定されたページは見つかりませんでした。変更、または削除された可能性があります。
            <br><br>
